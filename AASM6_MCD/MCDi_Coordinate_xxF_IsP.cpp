...
LRESULT MCDi_Coordinate_xxF_IsP(COMPLEXARRAY* const retVal,	// Возвращаемый массив
...
FUNCTIONINFO AASM6_Coordinate_xxF_IsP = {
	"AASM6_Coordinate_xxF_IsP",					// Имя по которому функция будет вызываться в Mathcad
	...
	"\n\nФункция для определения относительной координаты фокуса изолированной несущей поверхности, -", // Описание функции
	(LPCFUNCTION)MCDi_Coordinate_xxF_IsP,		// Ссылка на исполняемый код
