...
LRESULT MCDi_Cx_Cil_N(COMPLEXARRAY* const retVal,	// Возвращаемый массив
	LPCCOMPLEXSCALAR    M,							// 1-й аргумент
	LPCCOMPLEXSCALAR    alpha)						// 2-й аргумент	
{
	...
	ErrC = AASM6::get_Cx_Cil_N(result, M->real, alpha->real, x_1);
...
FUNCTIONINFO AASM6_Cx_Cil_N = {
	"AASM6_Cx_Cil_N",					// Имя по которому функция будет вызываться в Mathcad
	"\n1: M  - число Маха, -; \n2: alpha - угол атаки, рад",				// Список входных параметров функции
	"\n\nФункция для определения среднего по длине цилиндра коэффициента сопротивления при обтекании цилиндра по нормали к его оси, -", // Описание функции
	(LPCFUNCTION)MCDi_Cx_Cil_N,			// Ссылка на исполняемый код
