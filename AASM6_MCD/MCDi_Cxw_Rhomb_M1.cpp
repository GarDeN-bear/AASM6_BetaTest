...
LRESULT MCDi_Cxw_Rhomb_M1(COMPLEXARRAY* const retVal,	// Возвращаемый массив
	LPCCOMPLEXSCALAR    M,								// 1-й аргумент
	LPCCOMPLEXSCALAR    cc,								// 2-й аргумент
	LPCCOMPLEXSCALAR    zeta_c,							// 3-й аргумент
	LPCCOMPLEXSCALAR    chi_c,							// 4-й аргумент
	LPCCOMPLEXSCALAR    lambda_c)						// 5-й аргумент
{
...
FUNCTIONINFO AASM6_Cxw_Rhomb_M1 = {
	"AASM6_Cxw_Rhomb_M1",					// Имя по которому функция будет вызываться в Mathcad
	"\n1: M - число Маха, -; \n2: cc - относительная толщина профиля, -; \n3: zeta_c - обратное сужение консолей, -; \n4: chi_c - угол стреловидности по линии максимальных толщин, рад; \n5: lambda_c - удлинение консолей несущей поверхности, -",			// Список входных параметров функции
	"\n\nФункция для определения коэффициента волнового сопротивления несущей поверхности с ромбовидным профилем при М >= 1, -", // Описание функции
	(LPCFUNCTION)MCDi_Cxw_Rhomb_M1,		// Ссылка на исполняемый код
