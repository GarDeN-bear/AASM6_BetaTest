...
LRESULT MCDi_Ms_Con(COMPLEXARRAY* const retVal,	// Возвращаемый массив
	LPCCOMPLEXSCALAR    M,							// 1-й аргумент
	LPCCOMPLEXSCALAR    teta_Con)					// 2-й аргумент	
{
	...
	ErrC = AASM6::get_Ms_Con(result, M->real, teta_Con->real, x_2, x_1);
...
FUNCTIONINFO AASM6_Ms_Con = {
	"AASM6_Ms_Con",					// Имя по которому функция будет вызываться в Mathcad
	"\n1: M - число Маха, -; \n2: teta_Con - полуугол при вершине конуса, рад",				// Список входных параметров функции
	"\n\nФункция для определения числа Маха на поверхности конуса, -", // Описание функции
	(LPCFUNCTION)MCDi_Ms_Con,			// Ссылка на исполняемый код
