...
LRESULT MCDi_nn_Eff2(COMPLEXARRAY* const retVal,	// Возвращаемый массив
	LPCCOMPLEXSCALAR    M,							// 1-й аргумент
	LPCCOMPLEXSCALAR    lambda_c,					// 2-й аргумент
	LPCCOMPLEXSCALAR    bb_r)						// 3-й аргумент
{
	...
	ErrC = AASM6::get_nn_Eff2(result, M->real, lambda_c->real, bb_r->real, x_2, x_1);
...
FUNCTIONINFO AASM6_nn_Eff2 = {
	"AASM6_nn_Eff2",					// Имя по которому функция будет вызываться в Mathcad
	"\n1: M - число Маха, -; \n2: lambda_c - удлинение консолей несущей поверхности, -; \n3: bb_r - относительная хорда руля, -",				// Список входных параметров функции
	"\n\nФункция для определения коэффициента, характеризующего относительную эффективность рулей, расположенных вдоль задней кромки, -", // Описание функции
	(LPCFUNCTION)MCDi_nn_Eff2,			// Ссылка на исполняемый код
