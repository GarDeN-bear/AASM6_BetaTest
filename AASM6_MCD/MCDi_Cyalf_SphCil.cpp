...
LRESULT MCDi_Cyalf_SphCil(COMPLEXARRAY* const retVal,	// Возвращаемый массив
	...
	LPCCOMPLEXSCALAR    lambda_cil)				// 3-й аргумент
{
	...
	ErrC = AASM6::get_Cyalf_SphCil(result, M->real, lambda_nos->real, lambda_cil->real, x_2, x_1);
...
FUNCTIONINFO AASM6_Cyalf_SphCil = {
	"AASM6_Cyalf_SphCil",					// Имя по которому функция будет вызываться в Mathcad
	"\n1: M  - число Маха, -; \n2: lambda_nos - удлинение носовой части фюзеляжа (0 - плоская, 0.5 - сферическая), -; \n3: lambda_cil - удлинение цилиндрической части фюзеляжа, -",				// Список входных параметров функции
	"\n\nФункция для определения производной по углу атаки коэффициента подъёмной силы цилиндра со сферическим затуплением или с плоским торцом, 1/рад", // Описание функции
	(LPCFUNCTION)MCDi_Cyalf_SphCil,			// Ссылка на исполняемый код
