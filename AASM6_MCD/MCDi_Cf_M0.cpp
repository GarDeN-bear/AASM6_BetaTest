...
LRESULT MCDi_Cf_M0(COMPLEXARRAY* const retVal,	// Возвращаемый массив
	LPCCOMPLEXSCALAR    Re,						// 1-й аргумент
...
FUNCTIONINFO AASM6_Cf_M0 = {
	"AASM6_Cf_M0",					// Имя по которому функция будет вызываться в Mathcad
	...
	"\n\nФункция для определения коэффициента трения плоской пластинки при М=0, -", // Описание функции
	(LPCFUNCTION)MCDi_Cf_M0,			// Ссылка на исполняемый код
