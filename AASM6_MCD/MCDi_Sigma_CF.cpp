...
LRESULT MCDi_Sigma_CF(COMPLEXARRAY* const retVal,	// Возвращаемый массив
	LPCCOMPLEXSCALAR    M,						// 1-й аргумент
	LPCCOMPLEXSCALAR    chi_0,				// 2-й аргумент
	LPCCOMPLEXSCALAR    alpha)				// 3-й аргумент
{
	...
	ErrC = AASM6::get_Sigma_CF(result, M->real, chi_0->real, alpha->real, x_2, x_1);
...
FUNCTIONINFO AASM6_Sigma_CF = {
	"AASM6_Sigma_CF",					// Имя по которому функция будет вызываться в Mathcad
	"\n1: M  - число Маха, -; \n2: chi_0 - угол стреловидности по передней кромке несущей поверхности, рад; \n3: alpha - угол атаки несущей поверхности, рад",			// Список входных параметров функции
	"\n\nФункция для определения множителя, учитывающего неполноту реализации подсасывающей силы консолей несущей поверхности, -", // Описание функции
	(LPCFUNCTION)MCDi_Sigma_CF,		// Ссылка на исполняемый код
