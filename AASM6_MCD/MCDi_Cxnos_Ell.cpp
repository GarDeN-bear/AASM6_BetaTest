...
LRESULT MCDi_Cxnos_Ell(COMPLEXARRAY* const retVal,	// Возвращаемый массив
	...
	LPCCOMPLEXSCALAR    lambda_nos)					// 2-й аргумент	
{
	...
	ErrC = AASM6::get_Cxnos_Ell(result, M->real, lambda_nos->real, x_2, x_1);
...
FUNCTIONINFO AASM6_Cxnos_Ell = {
	"AASM6_Cxnos_Ell",					// Имя по которому функция будет вызываться в Mathcad
	"\n1: M - число Маха, -; \n2: lambda_nos - удлинение носовой части фюзеляжа, -",				// Список входных параметров функции
	"\n\nФункция для определения коэффициента сопротивления давления эллиптической носовой части, -", // Описание функции
	(LPCFUNCTION)MCDi_Cxnos_Ell,			// Ссылка на исполняемый код
