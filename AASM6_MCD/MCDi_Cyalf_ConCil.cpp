...
LRESULT MCDi_Cyalf_ConCil(COMPLEXARRAY* const retVal,	// Возвращаемый массив
	...
	LPCCOMPLEXSCALAR    lambda_cil)				// 3-й аргумент
{
	...
	ErrC = AASM6::get_Cyalf_ConCil(result, M->real, lambda_nos->real, lambda_cil->real, x_2, x_1);
...
FUNCTIONINFO AASM6_Cyalf_ConCil = {
	"AASM6_Cyalf_ConCil",					// Имя по которому функция будет вызываться в Mathcad
	...
	"\n\nФункция для определения производной по углу атаки коэффициента подъёмной силы комбинации конус-цилиндр, 1/рад", // Описание функции
	(LPCFUNCTION)MCDi_Cyalf_ConCil,		// Ссылка на исполняемый код
