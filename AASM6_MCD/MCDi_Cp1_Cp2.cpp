...
LRESULT MCDi_Cp1_Cp2(COMPLEXARRAY* const retVal,	// Возвращаемый массив
...
FUNCTIONINFO AASM6_Cp1_Cp2 = {
	"AASM6_Cp1_Cp2",					// Имя по которому функция будет вызываться в Mathcad
	"\n1: M  - число Маха, -; \n2: key - ключ, определяющий коэффициент, который возвращает функция (0: Cp2/Cp1, 1: Cp1, 2: Cp2)",				// Список входных параметров функции
	"\n\nФункция для определения коэффициентов, определяющих давление на поверхности профиля по теории 2-ого приближения, -", // Описание функции
	(LPCFUNCTION)MCDi_Cp1_Cp2,			// Ссылка на исполняемый код
