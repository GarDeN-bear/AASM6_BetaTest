...
LRESULT MCDi_xi_M(COMPLEXARRAY* const retVal,	// Возвращаемый массив
	...
	LPCCOMPLEXSCALAR    lambda_cil)				// 3-й аргумент
{
	...
	ErrC = AASM6::get_xi_M(result, M->real, lambda_nos->real, lambda_cil->real, x_2, x_1);
...
FUNCTIONINFO AASM6_xi_M = {
	"AASM6_xi_M",					// Имя по которому функция будет вызываться в Mathcad
	...
	"\n\nФункция для определения множителя, учитывающего влияние числа Маха на смещение фокуса комбинации носовой части и цилиндра, -", // Описание функции
	(LPCFUNCTION)MCDi_xi_M,		// Ссылка на исполняемый код
