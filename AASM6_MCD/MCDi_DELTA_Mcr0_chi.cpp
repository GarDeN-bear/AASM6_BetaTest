...
LRESULT MCDi_DELTA_Mcr0_chi(COMPLEXARRAY* const retVal,	// Возвращаемый массив
	LPCCOMPLEXSCALAR    Mcr_pr0,						// 1-й аргумент
	LPCCOMPLEXSCALAR    chi_c)				// 2-й аргумент	
{
...
FUNCTIONINFO AASM6_DELTA_Mcr0_chi = {
	"AASM6_DELTA_Mcr0_chi",					// Имя по которому функция будет вызываться в Mathcad
	"\n1: Mcr_pr0  - критическое число Маха профиля при нулевом коэффициенте нормальной силы консолей, -; \n2: chi_c - угол стреловидности по линии максимальных толщин, рад",				// Список входных параметров функции
	"\n\nФункция для определения поправки к критическому числу Маха, учитывающей стреловидность несущей поверхности, -", // Описание функции
	(LPCFUNCTION)MCDi_DELTA_Mcr0_chi,			// Ссылка на исполняемый код
