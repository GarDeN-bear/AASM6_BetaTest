...
LRESULT MCDi_Re_t0_1(COMPLEXARRAY* const retVal,	// Возвращаемый массив
	LPCCOMPLEXSCALAR    M,						// 1-й аргумент
	LPCCOMPLEXSCALAR    Re,						// 2-й аргумент
	LPCCOMPLEXSCALAR    hh)						// 3-й аргумент
{
	...
	ErrC = AASM6::get_Re_t0_1(result, M->real, Re->real, hh->real, x_2, x_1);
...
FUNCTIONINFO AASM6_Re_t0_1 = {
	"AASM6_Re_t0_1",					// Имя по которому функция будет вызываться в Mathcad
	"\n1: M  - число Маха, -; \n2: Re - число Рейнольдса, -; \n3: hh - относительная высота бугорков шероховатости поверхности, -",				// Список входных параметров функции
	"\n\nФункция для определения критического числа Рейнольдса при шероховатой поверхности тела, отсутствии теплопередачи и нулевом градиенте давления, -", // Описание функции
	(LPCFUNCTION)MCDi_Re_t0_1,			// Ссылка на исполняемый код
