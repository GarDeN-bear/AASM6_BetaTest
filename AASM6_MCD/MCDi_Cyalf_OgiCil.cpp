...
LRESULT MCDi_Cyalf_OgiCil(COMPLEXARRAY* const retVal,	// Возвращаемый массив
...
FUNCTIONINFO AASM6_Cyalf_OgiCil = {
	"AASM6_Cyalf_OgiCil",					// Имя по которому функция будет вызываться в Mathcad
	...
	"\n\nФункция для определения производной по углу атаки коэффициента подъёмной силы комбинации оживало-цилиндр, 1/рад", // Описание функции
	(LPCFUNCTION)MCDi_Cyalf_OgiCil,		// Ссылка на исполняемый код
